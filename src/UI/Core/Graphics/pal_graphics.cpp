...
void Graphics_DrawRoundedRectangle(const PAL_GFX_Bitmap& bitmap, const GFX_Pen& pen, const GFX_Rect& rectangle, int radiusX, int radiusY)
{
...
void Graphics_Driver::DrawRoundedRectangle(const PAL_GFX_Bitmap& bitmap, const GFX_Pen& pen, const GFX_Rect& rectangle,	int radiusX, int radiusY)
{
	GFX_Pen nativePen = ConvertPenToNative(pen);
