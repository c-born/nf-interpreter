...
HRESULT Library_graphics_native_Bitmap::_ctor___VOID__I4__I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
    ...
    NANOCLR_CHECK_HRESULT(CLR_GFX_Bitmap::CreateInstance( pThis[ FIELD__m_bitmap ], bm ));
...
HRESULT Library_graphics_native_Bitmap::_ctor___VOID__SZARRAY_U1__BitmapBitmapImageType( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
    ...
    NANOCLR_CHECK_HRESULT(CLR_GFX_Bitmap::CreateInstance( pThis[ FIELD__m_bitmap ], imageData, imageDataSize, imageType ));
...
HRESULT Library_graphics_native_Bitmap::Dispose___VOID__BOOLEAN( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::Flush___VOID( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
    ...
    bitmap->Screen_Flush( *bitmap, 0, 0, bitmap->m_bm.m_width, bitmap->m_bm.m_height );

    NANOCLR_NOCLEANUP();
}

HRESULT Library_graphics_native_Bitmap::Flush___VOID__I4__I4__I4__I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
    ...
    bitmap->Screen_Flush( *bitmap, (CLR_UINT16)x, (CLR_UINT16)y, (CLR_UINT16)width, (CLR_UINT16)height );

    NANOCLR_NOCLEANUP();
}

HRESULT Library_graphics_native_Bitmap::Clear___VOID( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::DrawTextInRect___BOOLEAN__BYREF_STRING__BYREF_I4__BYREF_I4__I4__I4__I4__I4__U4__PresentationMediaColor__Font( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
    ...
    NANOCLR_CHECK_HRESULT(                                                  GetBitmap( stack, true, bitmap ));
    NANOCLR_CHECK_HRESULT(Library_graphics_native_Font::GetFont  ( &pArgs[ 9 ], font   ));
...
HRESULT Library_graphics_native_Bitmap::SetClippingRectangle___VOID__I4__I4__I4__I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::get_Width___I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::get_Height___I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::DrawEllipse___VOID__PresentationMediaColor__I4__I4__I4__I4__I4__PresentationMediaColor__I4__I4__PresentationMediaColor__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::RotateImage___VOID__I4__I4__I4__Bitmap__I4__I4__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::DrawImage___VOID__I4__I4__Bitmap__I4__I4__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::MakeTransparent___VOID__PresentationMediaColor( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::StretchImage___VOID__I4__I4__Bitmap__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::DrawLine___VOID__PresentationMediaColor__I4__I4__I4__I4__I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::DrawRectangle___VOID__PresentationMediaColor__I4__I4__I4__I4__I4__I4__I4__PresentationMediaColor__I4__I4__PresentationMediaColor__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::DrawText___VOID__STRING__Font__PresentationMediaColor__I4__I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
    ...
    NANOCLR_CHECK_HRESULT(                                                    GetBitmap( stack, true, bitmap ));
    NANOCLR_CHECK_HRESULT(Library_graphics_native_Font  ::GetFont  ( &pArgs[ 1 ], font   ));
...
HRESULT Library_graphics_native_Bitmap::SetPixel___VOID__I4__I4__PresentationMediaColor( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::GetPixel___PresentationMediaColor__I4__I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::GetBitmap___SZARRAY_U1( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::GetBitmap( CLR_RT_HeapBlock* pThis, bool fForWrite, CLR_GFX_Bitmap*& bitmap )
{
    NANOCLR_HEADER();
    ...
    NANOCLR_CHECK_HRESULT(CLR_GFX_Bitmap::GetInstanceFromGraphicsHeapBlock(pThis[ FIELD__m_bitmap ], bitmap));
...
HRESULT Library_graphics_native_Bitmap::GetBitmap( CLR_RT_StackFrame& stack, bool fForWrite, CLR_GFX_Bitmap*& bitmap )
{
    return GetBitmap( &stack.Arg0(), fForWrite, bitmap );
}

HRESULT Library_graphics_native_Bitmap::StretchImage___VOID__I4__I4__I4__I4__Bitmap__I4__I4__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::TileImage___VOID__I4__I4__Bitmap__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native_Bitmap::Scale9Image___VOID__I4__I4__I4__I4__Bitmap__I4__I4__I4__I4__U2( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
