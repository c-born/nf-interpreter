...
HRESULT BmpDecoder::BmpInitOutput(const CLR_UINT8* src, CLR_UINT32 srcSize)
{
    ...
    NANOCLR_CHECK_HRESULT(source.Skip(sizeof(BITMAPFILEHEADER))); // Note that pbmfh->bfSize records the size of the entire bitmap image, NOT the size of the struct
